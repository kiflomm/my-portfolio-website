  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-20">
        <motion.div
          className="absolute top-20 left-4 md:left-6 lg:left-8"
          animate={{
            y: [0, -10, 0],
          }}
          transition={{
        ...
        <motion.div
          className="absolute top-1/3 left-4 md:left-6 lg:left-8"
          animate={{
            y: [0, 10, 0],
          }}
          transition={{
      ...
      <motion.div
        ...
        className="relative z-30 w-full max-w-5xl mx-auto px-4 md:px-8"
      >
        {/* Profile Picture */}
          <motion.div
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-primary via-purple-600 to-blue-600 dark:from-primary dark:via-purple-400 dark:to-blue-400 bg-clip-text text-transparent">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 dark:bg-primary/20 border border-primary/20">
              ...
              <p className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-foreground">
            ...
            {[
              ...
              >
                <Link
                  href={social.href}
                  target="_blank"
                  className={`block p-2.5 sm:p-3 md:p-4 rounded-xl bg-card/50 dark:bg-card/30 border border-border/50 transition-all duration-300 ${social.color}`}
                >
                  {social.icon === "github" && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg bg-primary text-primary-foreground font-semibold text-xs sm:text-sm md:text-base overflow-hidden border-2 border-primary/50"
            >
            ...
            >
              <Link
                ...
                target="_blank"
                className="group relative block px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg bg-secondary/50 dark:bg-secondary/30 text-secondary-foreground font-semibold text-xs sm:text-sm md:text-base overflow-hidden border-2 border-border text-center"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Download Resume
